...
실행 : Degurba 로 이름 바꿔서 저장 -> Degruba 레이어로 area, rank 필드 생성 -> 각 개체의 면적 찾기 -> rank 부여
...
path = 'C:/Users/User/Desktop/지역분류체계/총정리/1_지역분류/1215test_new인구격자사용/Degurba00.shp'
'''

##<< save layer as testDegruba00 >>
path = 'C:/Users/User/Desktop/지역분류체계/총정리/1_지역분류/1216test_new인구격자사용/Degurba00.shp'
