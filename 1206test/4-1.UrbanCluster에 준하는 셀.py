...
_WHERE_TOT_FIELD = 2
_WHERE_GAP_FIELD = 3
_WHERE_NEIGHBORS_FIELD = 4
_WHERE_ID_FIELD = 5
_WHERE_FLAG_FIELD = 6
_WHERE_TOT_SUM_FIELD = 7
_WHERE_LAND_FIELD = 8
_WHERE_IS_CLUSTER_FIELD = 9
...
infn = "D:/grid22/is_cluster_20.shp"
outfn2 = "D:/grid22/urbancluster에준하는셀_dissolve.shp"
