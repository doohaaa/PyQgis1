...
####select_by_Expression('"TOT">=1500 or "gap" != 0')

##<< Save selected part to vector layer >>
####fn1 = 'C:/Users/User/Desktop/지역분류체계/urban_emd_20/인구격자읍면동_20_부산/1018test/1018test.shp'
...
##<< Save selected part to vector layer >>
_writer = QgsVectorFileWriter.writeAsVectorFormat(layer,
                                                  'C:/Users/User/Desktop/지역분류체계/urban_emd_20/인구격자읍면동_20_부산/1018test2/is_cluster_1.shp',
                                                  "EUC-KR", layer.crs(), "ESRI Shapefile", onlySelected=True)
...
infn = "C:/Users/User/Desktop/지역분류체계/urban_emd_20/인구격자읍면동_20_부산/1018test2/is_cluster_1.shp"
outfn2 = "C:/Users/User/Desktop/지역분류체계/urban_emd_20/인구격자읍면동_20_부산/1018test2/dissolve1018.shp"
