    ...
    for a in feature_dict.values():
        ...
        if (a.attributes()[_WHERE_UC_FIELD] == 1):
            ...
            if (a.attributes()[_WHERE_FLAG_FIELD] == 0):
                ...
                land += 1
                ##print('%s의 TOT는 %d' %(a.attributes()[_WHERE_ID_FIELD],sum))
                if (sum >= 5000):
...
_writer = QgsVectorFileWriter.writeAsVectorFormat(layer,
                                                  'C:/Users/User/Desktop/지역분류체계/urban_emd_20/인구격자읍면동_20_부산/1024test_UrbanCenter&Cluster/is_cluster_2.shp',
...
infn = "C:/Users/User/Desktop/지역분류체계/urban_emd_20/인구격자읍면동_20_부산/1024test_UrbanCenter&Cluster/is_cluster_2.shp"
outfn2 = "C:/Users/User/Desktop/지역분류체계/urban_emd_20/인구격자읍면동_20_부산/1024test_UrbanCenter&Cluster/urbancluster_dissolve1024.shp"
