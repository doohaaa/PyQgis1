'''
Degruba
레이어 : inter_id까지 부여된 intersection 레이어 -> Degruba 로 이름 바꿔서 저장
실행 : Degruba 레이어로 area, rank 필드 생성 -> 각 개체의 면적 찾기 -> rank 부여
