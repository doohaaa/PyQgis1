...
###################################
##<<300명이상 1500이하만 뽑아내기>>
layer.selectByExpression('"TOT"<=1500 and "TOT>=300',QgsVectorLayer.SetSelection)


###################################
##<<선택 부분 벡터레이어로 저장>>
_writer=QgsVectorFileWriter.writeAsVectorFormat(layer,'C:/Users/User/Desktop/지역분류체계/urban_emd_20/인구격자읍면동_20_부산/1011test_UrbanCluster/1011test.shp',"EUC-KR",layer.crs(),"ESRI Shapefile", onlySelected=True)
...
###################################
##<<저장한 벡터레이어 불러오기>>
layer=iface.addVectorLayer('C:/Users/User/Desktop/지역분류체계/urban_emd_20/인구격자읍면동_20_부산/1011test_UrbanCluster','','ogr')


####################################################
##인근 격자 구하기 - 8개 돌며 구하고 neighbors_에 추가
...
##################################
##<<neighbors_ 통합 (=cluster 통합)>> - 2차원 list
from qgis.utils import iface
from PyQt5.QtCore import QVariant
...
# location of field
_WHERE_FLAG_FIELD = 20
_WHERE_NEIGHBORS_FIELD = 18
_WHERE_ID_FIELD = 19
_WHERE_TOT_FIELD = 5
...
###############################################
##<<NEIGHBORS의 값의 합 v11, cluster >> - TOT_SUM, land 구하기
from qgis.utils import iface
from PyQt5.QtCore import QVariant
...
_WHERE_NEIGHBORS_FIELD = 18
_WHERE_ID_FIELD = 19
_WHERE_TOT_SUM_FIELD = 21
_WHERE_NAME_FIELD = 0
_WHERE_LAND_FIELD = 22
_WHERE_IS_CLUSTER_FIELD = 23
...
###############################
##<<선택 부분 벡터레이어로 저장>>
_writer=QgsVectorFileWriter.writeAsVectorFormat(layer,'C:/Users/User/Desktop/지역분류체계/urban_emd_20/인구격자읍면동_20_부산/1011test_UrbanCluster/is_cluster_1.shp',"EUC-KR",layer.crs(),"ESRI Shapefile", onlySelected=True)
...
infn = "C:/Users/User/Desktop/지역분류체계/urban_emd_20/인구격자읍면동_20_부산/1011test_UrbanCluster/is_cluster_1.shp"
outfn2="C:/Users/User/Desktop/지역분류체계/urban_emd_20/인구격자읍면동_20_부산/1011test_UrbanCluster/dissolve1012.shp"
...
############################
##<<dissolve 된 파일 가져와>>
layer3=iface.addVectorLayer('C:/Users/User/Desktop/지역분류체계/urban_emd_20/인구격자읍면동_20_부산/1011test_UrbanCluster/dissolve1012.shp','','ogr')